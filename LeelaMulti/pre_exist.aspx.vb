    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack() Then
            ...
            Try
                ...
                RN = commonFun.DecrptQueryString("RN", qs)
                RN = ""
                If RN = "4000" Or RN = "4001" Or RN = "3090" Or RN = "11" Then
                    RN = ""
                End If
    ...
    Protected Sub wired(ByVal room As String, ByVal lastname As String)
        ...
        Else
            ...
            Try
                ...
                Response.Redirect("UserError.aspx?" & GetRedirectQS() & "&Msg=" & "Dear Guest, Please purchase plan by logging as New User." & "&findurl=mifilogin" & "&ct=" & Page.UICulture)
            Catch ex As Exception
