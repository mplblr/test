...
<%@ Page Language="vb" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="usererror.aspx.vb"
    Inherits="LeelaMulti.usererror" Title="Hyatt Regency" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlace" runat="server">
    ...
    <div id="user_error">
        ...
        <div id="msgPara" runat="server" style="margin-top: .7em; margin-bottom: .7em;">
